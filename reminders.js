...

{
    ...
    if (theDayclickedReminder != null) {
...

        {
                ...
                x = prompt("Enter a reminder for day "+ day + " of this month at any time", theDayclickedReminder);
...
function showReminders() {
  ...
  for (i = 0; i < notifs.length; i++) {
    text += "-  " + "<i>" + "August " + days[i] + "</i>" + ": " + "<strong>" + notifs[i] + "</strong>" + "<br>";
  }
  document.getElementById("demo").innerHTML = text;
  // allRem = JSON.stringify(text);
  // var fs = require('fs');
  // fs.writeFile('rem.json', allRem, 'utf8', callback);
